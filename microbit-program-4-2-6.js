...
basic.forever(function () {
    ...
    basic.pause(10)
    //reads the inputs and output their values to LEDs
    let origPin = pins.digitalReadPin(DigitalPin.P2)
    led.plotBrightness(2, 0, origPin * 250 + 5)
    let equiPin = pins.digitalReadPin(DigitalPin.P1)
    led.plotBrightness(3, 0, equiPin * 250 + 5)
